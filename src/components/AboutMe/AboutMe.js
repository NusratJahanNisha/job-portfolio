...
// import { faClipboardList, faGithub } from '@fortawesome/free-solid-svg-icons';
const AboutMe = () => {
    ...
    return (
        <div className="container bg-dark" style={{ display:"cover" }} >
            ...
            {/* <i class="fab fa-github"></i> */}
             ...
             <br/>
             <a target="_blank" href="https://www.linkedin.com/in/nusrat-jahan-nisha-3788b61ba/"> <button type="button" class="btn btn-outline-light ml-2"> <b> LinkedIn</b> </button></a>
             <a target="_blank" href="https://github.com/NusratJahanNisha">  <button type="button" class="btn btn-light ml-2"> <b> Github</b></button></a>
            <br/> <br/>
         ...
         <h5 style={{color:"white"}}>A hard working, experienced website developer studying in   Materials <br/> Science and Engineering.  Passionate  to   programming,  culture,<br/> sports and music. A dreamer who works day and night <br/> to achieve the peak she cherishes.</h5> <br/>
            ...
            <button type="button" onClick={handleMessage} class="btn btn-outline-light ml-2"> <b> Send Message</b> </button>
           <a href="https://docs.google.com/uc?export=download&id=1pq8_e7VCJ3FbWHHI87z-pkT6-nJiBVwD">
           <button type="button" class="btn btn-light ml-2"> <b> Download Resume</b></button>
           </a>
           </div>
           <br/>  <br/> <br/> <br/>
            <div class="card-deck" style={{ color: "white" }}>
                <div class="card" >
                    <div class="card-body bg-dark" style={{ boxShadow: "5px 5px 5px 5px white" }}>
            ...
            <br/> <br/> <br/>
            {/* <a href="https://docs.google.com/uc?export=download&id=1pq8_e7VCJ3FbWHHI87z-pkT6-nJiBVwD">
           <button type="button" style={{width:"600px",height:"50px",marginBottom:"20px"}} class="btn btn-light ml-2"> <b> Download Resume</b></button>
           </a> */}
        </div>
    );
};
